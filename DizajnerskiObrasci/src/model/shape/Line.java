...
public class Line extends Shape implements Serializable {
	...
	public Line(Point startPoint, Point point, boolean selected) {
		this(startPoint, point);
		setSelected(selected);
	}

	public Line(Point startPoint, Point point, boolean selected, Color color) {
		this(startPoint, point, selected);
		setColor(color);
	}
	...
	public String toString() {
		return "start: " + startPoint + " end: " + endPoint + " color: " + this.getColor().getRGB();
	}
	...
	@Override
	public Line clone() {
		return new Line(this.getStartPoint().clone(), this.getEndPoint().clone(), false, this.getColor());
	}
}
